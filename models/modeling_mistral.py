...
from utils_yl_ratio_avgpool_v2 import KVCluster # [YL]
...
class MistralFlashAttention2(MistralAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # [YL] change attention_mask to None
...
class MistralModel(MistralPreTrainedModel):
    ...
    def forward(
        ...
        # if False: # [YL] attention_mask is used for compression
    ...
    def prepare_inputs_for_generation(
        ...
        if past_key_values is not None:
            if isinstance(past_key_values, Cache):
                ...
                # if len(past_key_values) == 0: # [YL] for the first time, past_key_values is empty
                #     print('fuck')
                #     for layer in self.model.layers:
